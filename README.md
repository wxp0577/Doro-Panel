...
一个功能丰富的自托管导航面板，支持多用户、主题插件、立绘表情包、股票天气等功能。
...
- **主题插件系统** - 支持上传第三方主题插件，一键切换
- **功能插件系统** - 预留功能插件接口，可扩展新功能
- **极简模式** - 纯净搜索页，独立壁纸和特效
...
所有数据（网站配置、分类、股票、用户、设置、上传的壁纸/表情包/立绘）存储在 Docker 卷 `doro_data` 中。
